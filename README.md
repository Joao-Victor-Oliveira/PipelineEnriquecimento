...
A solução consiste em uma pipeline automatizada que coleta dados brutos de uma API, processa-os em camadas de Data Warehouse e disponibiliza em uma API e por último
a visuzalição num dashboard analítico.
...
O que o projeto faz:
    ...
    Exposição: Uma API que serve dados analíticos.
...
Arquitetura Data Warehouse
    ...
    Controle do processo Através da tabela estado_pipeline_dw

Workflows n8n (3 partes):
